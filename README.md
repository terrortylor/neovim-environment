...
1. [Installation](#Installation)
   1. [Checking out the repository](#Checking_out_the_repository)
   1. [Setting up symlinks](#Setting_up_symlinks)
1. [Plugins](#Plugins)
   1. [Third Party Plugins](#Third_Party_Plugins)
   1. [Custom Plugins](#Custom_Plugins)
      1. [gittools](#gittools)
      1. [websearch](#websearch)
      1. [focus](#focus)
      1. [terminal](#terminal)
   1. [File Type Plugins](#File_Type_Plugins)
      1. [markdown](#markdown)
      1. [chef](#chef)
      1. [note](#note)
1. [Custom Functions](#Custom_Functions)
1. [TabbedQuicklist](#TabbedQuicklist)
1. [Noteworthy Key Mappings](#Noteworthy_Key_Mappings)
