...
local function assertLineIsCapture(line, expected)
  local line_txt = vim.api.nvim_buf_get_lines(0, line - 1, line, false)[1]
  local cur_pos, _ = line_txt:find("%p")
  local captures = vim.treesitter.get_captures_at_pos(0, line - 1, cur_pos)
...
describe("markdown.tasks", function()
  ...
  describe("neorgtools.indent", function()
    ...
    it("should change unordered list 1 to unorderd list 2", function()
      openGolden("list.norg")
      assertLineIsCapture(1, "neorg.lists.unordered.1.prefix")
      goToLineAnd(1, testModule.indent)
      assertLineIsCapture(1, "neorg.lists.unordered.2.prefix")
    end)
    it("should change unordered list 2 to unorderd list 1", function()
      openGolden("list.norg")
      assertLineIsCapture(2, "neorg.lists.unordered.2.prefix")
      goToLineAnd(2, testModule.dedent)
      assertLineIsCapture(2, "neorg.lists.unordered.1.prefix")
    end)
    -- check when formatting off
    it("should change unordered list 1 to unorderd list 2", function()
      openGolden("list.norg")
      assertLineIsCapture(6, "neorg.lists.unordered.1.prefix")
      goToLineAnd(6, testModule.indent)
      assertLineIsCapture(6, "neorg.lists.unordered.2.prefix")
    end)
    it("should change ordered list 1 to orderd list 2", function()
      openGolden("ordered-list.norg")
      assertLineIsCapture(1, "neorg.lists.ordered.1.prefix")
      goToLineAnd(1, testModule.indent)
      assertLineIsCapture(1, "neorg.lists.ordered.2.prefix")
    end)
    it("should change ordered list 2 to orderd list 1", function()
      openGolden("ordered-list.norg")
      assertLineIsCapture(2, "neorg.lists.ordered.2.prefix")
      goToLineAnd(2, testModule.dedent)
      assertLineIsCapture(2, "neorg.lists.ordered.1.prefix")
    end)
  end)
end)
