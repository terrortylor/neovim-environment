...
function M.key_pressed(key)
	if key == "right" and direction[#direction] ~= "right" and direction[#direction] ~= "left" then
		table.insert(direction, "right")
	elseif key == "left" and direction[#direction] ~= "left" and direction[#direction] ~= "right" then
